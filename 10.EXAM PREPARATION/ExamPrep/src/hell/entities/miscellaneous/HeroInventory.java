...
public class HeroInventory implements Inventory {
   ...
   //    String result = "Items: None";
   //    if (this.commonItems.values().size()>0){
   //        result = String.join(System.lineSeparator(),this.commonItems.values().toString());
   //        result = "Items: " + System.lineSeparator() + result.replaceAll("[\\[\\]]","");
   //    }
   //    return result;
   //}
