...
public class HeroRepository {
    ...
    public void remove(String name) {
        ...
        if (hero==null){
            throw new NullPointerException("Hero doesn't exist");
        }
    ...
    public Hero getHeroWithHighestStrength() {
        ...
        if (bestHero==null){
            throw new NullPointerException("Hero with highest strength not found");
        }
        return bestHero;
    }
    ...
    public Hero getHeroWithHighestAgility() {
        ...
        if (bestHero==null){
            throw new NullPointerException("Hero with highest agility not found");
        }
        return bestHero;
    }
    ...
    public Hero getHeroWithHighestIntelligence() {
        ...
        if (bestHero==null){
            throw new NullPointerException("Hero with highest intelligence not found");
        }
        return bestHero;
    }
